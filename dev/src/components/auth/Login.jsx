    ...
    <div className="min-h-screen flex items-center justify-center" style={{
      ...
      <div className="w-full max-w-[380px]">
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-8" style={{ height: '420px' }}>
            <h2 className="text-2xl font-medium text-center text-[#16222A] mb-8">Welcome Back</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center mt-4">
                <span className="text-[#16222A]">Don't have an account? </span>
                <Link to="/register" className="text-[#16222A] font-medium hover:underline">
                  Sign Up
                </Link>
              </div>
            </form>
